    ...
    return (
        <div>
            ...
            <form onSubmit={handleFormSubmit}>
                <label style={{marginTop:"20px"}}>Product Id: <input type='text' name='product_id' value={editData.product_id} onChange={handleChange}/>
                </label> <br /> <br />
                <label>Product Name: <input type='text' name='product_name' value={editData.product_name} onChange={handleChange}/>
                </label> <br /> <br />
                <label>Product Price: <input type='text' name='product_price' value={editData.product_price} onChange={handleChange}/>
                </label> <br /> <br />
                <label>Product Description: <input type='text' name='product_description' value={editData.product_description} onChange={handleChange}/>
                </label> <br /> <br />
